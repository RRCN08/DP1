$(document).ready(function() {
      ...
      $('#Chirang').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "Chirang_basugaon");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "chirang_bijni");
      ...
      $('#Goalpara').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "Goalpara_lakhipur");
      ...
      $('#Barpeta').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "barpeta_howly");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "barpeta_sarthebari");

        $(".Player3").attr("style", "display: inline-block;");
        $(".Player3").attr("id", "barpeta_sorbhog");
      ...
      $('#Nalbari').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "Nalbari");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "Nalbari_tihu");
      ...
      $('#Biswanath').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "biswanath");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "biswanath_gohpur");
      ...
      $('#Nagaon').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "nagaon");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "Nagaon_kampur");

        $(".Player3").attr("style", "display: inline-block;");
        $(".Player3").attr("id", "Nagaon_dhing");
      ...
      $('#Sonitpur').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "Sonitpur_rangapara");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "Sonitpur_tezpur");

        $(".Player3").attr("style", "display: inline-block;");
        $(".Player3").attr("id", "sonitpur_dhekiajuli");
      ...
      $('#Karbi_Anglong').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "Karbi_Anglong_howraghat");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "Karbi_Anglong_dokmoka");
      ...
      $('#Golaghat').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "golaghat_bokakhat");
      ...
      $('#Jorhat').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "jorhat");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "Jorhat_titabor");
      ...
      $('#Lakhimpur').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "lakhimpur");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "lakhimpur_bihpuria");
      ...
      $('#Sivasagar').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "sivasagar");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "sivasagar_demow");
      ...
      $('#Charaideo').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "Charaideo_sonari");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "Charaideo_moranhat");
      ...
      $('#Dhemaji').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "dhemaji");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "Dhemaji_silapothar");

        $(".Player3").attr("style", "display: inline-block;");
        $(".Player3").attr("id", "Dhemaji_jonai");
      ...
      $('#Dibrugarh').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "Dibrugarh_chabua");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "Dibrugarh_duliajan");

        $(".Player3").attr("style", "display: inline-block;");
        $(".Player3").attr("id", "dibrugarh_naharkatia");

        $(".Player4").attr("style", "display: inline-block;");
        $(".Player4").attr("id", "dibrugarh_namrup");

        $(".Player5").attr("style", "display: inline-block;");
        $(".Player5").attr("id", "dibrugarh");
      ...
      $('#Tinsukia').on('click',function(){
        ...
        $(".Player1").attr("style", "display: inline-block;");
        $(".Player1").attr("id", "Tinsukia_dhola");

        $(".Player2").attr("style", "display: inline-block;");
        $(".Player2").attr("id", "Tinsukia_digboi");

        $(".Player3").attr("style", "display: inline-block;");
        $(".Player3").attr("id", "Tinsukia_ledo");

        $(".Player4").attr("style", "display: inline-block;");
        $(".Player4").attr("id", "Tinsukia_doomdooma");

        $(".Player5").attr("style", "display: inline-block;");
        $(".Player5").attr("id", "Tinsukia_makum");

        $(".Player6").attr("style", "display: inline-block;");
        $(".Player6").attr("id", "Tinsukia_margherita");

        $(".Player7").attr("style", "display: inline-block;");
        $(".Player7").attr("id", "tinsukia");
